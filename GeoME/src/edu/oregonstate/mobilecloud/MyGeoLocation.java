...
public class MyGeoLocation extends Activity implements LocationListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button) findViewById(R.id.buttonSendCoordinates);

        final Button button = (Button) findViewById(R.id.buttonSendCoordinates);
    ...
    //TODO add get location method for GAE push
}
